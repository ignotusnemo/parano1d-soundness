...
Each directory is an agent-ready research task tied to one active public contract. A researcher chooses a task, gives its `AGENT_TASK.md` to any local AI agent and submits only passive result data under `platform/submissions/<id>/`.

From `platform/`, list and create a submission with:
